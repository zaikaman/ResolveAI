...
CREATE TABLE public.users (
  ...
  timezone character varying DEFAULT '''America/New_York''::character varying'::character varying,
  language character varying DEFAULT '''en''::character varying'::character varying,
